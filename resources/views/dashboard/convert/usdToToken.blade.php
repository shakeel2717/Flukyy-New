    ...
    <div class="row gx-2 gx-lg-3">
        <div class="col-sm-12">
            <div class="card h-100">
                <div class="card-body">
                    <h6 class="card-subtitle mb-2">Conver USD To Token</h6>
                    <hr>
                ...
                <form action="{{ route('usdToTokenReq') }}" method="POST">
                    @csrf
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="">USD Amount to Convert</label>
                            <input type="text" name="amount" id="amount" class="form-control" placeholder="USD Amount to Convert">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
